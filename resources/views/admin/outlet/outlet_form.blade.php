                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label"><span class="required-icon">* </span>Owner
                                                Name</label>
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->owner_name ?? '' }}" id="owner_name"
                                                name="owner_name">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label"><span class="required-icon">* </span>Outlet
                                                Name</label>
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->name ?? '' }}" id="name" name="name">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label"><span class="required-icon">* </span>Access
                                                URL</label>
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->url ?? '' }}" id="url" name="url">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="email"
                                                value="{{ $outlet_data->email ?? '' }}" id="email" name="email">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->phone ?? '' }}" id="phone" name="phone">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label"><span class="required-icon">* </span>Minimum
                                                Order</label>
                                            <input class="form-control form-control-alternative" type="number"
                                                value="{{ $outlet_data->minimum_order ?? '0' }}" id="minimum_order"
                                                name="minimum_order">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->address ?? '' }}" id="address" name="address">
                                            <small class="text-muted"> <strong>&nbsp;Use address suggestion for accurate
                                                    data</strong> </small>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->lat ?? '' }}" id="lat" name="lat" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->long ?? '' }}" id="long" name="long" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->country ?? '' }}" id="country" name="country">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->city ?? '' }}" id="city" name="city">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->state ?? '' }}" id="state" name="state">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label"><span class="required-icon">* </span>Postal
                                                Code</label>
                                            <input class="form-control form-control-alternative" type="text"
                                                value="{{ $outlet_data->post_code ?? '' }}" id="post_code"
                                                name="post_code">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-12 col-md-12 col-sm-12">
                                        <div class="form-group text-center">
                                            ...
                                            <div style="display: flex;justify-content: center;">
                                                <input type="file" name="outlet_logo" class="dropify"
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12">
                                        <div class="form-group text-center">
                                            ...
                                            @endphp
                                            <div style="display: flex;justify-content: center;">
                                                <input type="file" name="fav_icon" class="dropify"
                                                    data-default-file="{{ $path }}" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12">
                                        <div class="form-group text-center">
                                            ...
                                            @endphp
                                            <div style="display: flex;justify-content: center;">
                                                <input type="file" name="admin_logo" class="dropify"
                                                    data-default-file="{{ $path }}" />
                                            </div>
                                        </div>
                                    </div>
