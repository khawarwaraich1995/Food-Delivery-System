...
Vue.component('update-password', require('./components/pages/auth/components/updatePassword.vue').default);
Vue.component('cart-card', require('./components/component/cartCard.vue').default);
Vue.component('restaurant-cover', require('./components/component/restaurantCover.vue').default);
Vue.component('restaurant-tabs', require('./components/component/restaurantTabs.vue').default);
Vue.component('menu-listing', require('./components/component/menu-page-components/menu.vue').default);
Vue.component('restaurant-info', require('./components/component/menu-page-components/info.vue').default);
Vue.component('table-booking', require('./components/component/menu-page-components/table-booking.vue').default);
Vue.component('restaurant-rating', require('./components/component/menu-page-components/rating-section.vue').default);
