              ...
              <div class="col-lg-8">
                <div class="tab-content">
                  ...
                  <div
                    ...
                    id="settings"
                  >
                    <profile-settings :userDetails="user"></profile-settings>
                  </div>
                    <div
                    class="setting-main-area verification_area tab-pane fade"
                    id="security"
                  >
                  <update-password :userDetails="user"></update-password>
                  </div>
                  <div
                    class="setting-main-area verification_area tab-pane fade"
                    id="ratting_menu"
...
export default {
  data() {
    return {
      userImg: 'https://cdn.icon-icons.com/icons2/1736/PNG/512/4043260-avatar-male-man-portrait_113269.png',
    };
  },
  computed: {
    ...mapGetters(["isLogged"]),
